...
var Tonal = (() => {
  ...
  var pt = (t, n) => {
      for (var e in n) ft(t, e, { get: n[e], enumerable: !0 });
    },
    Wn = (t, n, e, r) => {
      if ((n && typeof n == "object") || typeof n == "function")
        for (let o of Qn(n))
          !Jn.call(t, o) &&
            ...
            ft(t, o, {
              get: () => n[o],
              enumerable: !(r = Xn(n, o)) || r.enumerable,
            });
      return t;
    };
  var Yn = (t) => Wn(ft({}, "__esModule", { value: !0 }), t);
  var la = {};
  pt(la, {
    AbcNotation: () => nn,
    Array: () => bt,
  ...
  function s(t) {
    ...
    if (e) return e;
    let r =
      typeof t == "string" ? re(t) : q(t) ? s(oe(t)) : k(t) ? s(t.name) : Jt;
    return Ut.set(n, r), r;
  }
  ...
  function re(t) {
    ...
    let e = n[0],
      ...
      i = _(r),
      m = o.length ? +o : void 0,
      c = Y({ step: a, alt: i, oct: m }),
      P = e + r + o,
      h = e + r,
      j = (Pt[a] + i + 120) % 12,
      f = m === void 0 ? ee(Pt[a] + i, 12) - 12 * 99 : Pt[a] + i + 12 * (m + 1),
      x = f >= 0 && f <= 127 ? f : null,
      C = m === void 0 ? null : Math.pow(2, (f - 69) / 12) * 440;
    return {
      empty: !1,
      acc: r,
      alt: i,
  ...
  function ce(t, n) {
    return (n === "M" && t === "majorable") ||
      ...
      ? n.length
      : /^d+$/.test(n)
      ? -1 * (t === "perfectable" ? n.length : n.length + 1)
      : 0;
  }
  function ue(t) {
    ...
    let a = n + 1 + 7 * r,
      i = a === 0 ? n + 1 : a,
      m = o < 0 ? "-" : "",
      c = Wt[n] === "M" ? "majorable" : "perfectable";
    return m + i + le(c, e);
  }
  function le(t, n) {
    return n === 0
  ...
  var Yt = (t, n) => Array(n + 1).join(t),
    de = /^(_{1,}|=|\^{1,}|)([abcdefgABCDEFG])([,']*)$/;
  function Zt(t) {
    let n = de.exec(t);
  ...
  var nn = {
    abcToScientificNotation: nt,
    scientificToAbcNotation: tn,
    tokenize: Zt,
    transpose: fe,
    distance: pe,
  };
  ...
  function Ae(t, n = Math.random) {
    let e,
      ...
      o = t.length;
    for (; o; )
      (e = Math.floor(n() * o--)), (r = t[o]), (t[o] = t[e]), (t[e] = r);
    return t;
  }
  function rn(t) {
    return t.length === 0
  ...
  var A = {
    ...
    At = (t) => Number(t).toString(2).padStart(12, "0"),
    mn = (t) => parseInt(t, 2),
    Se = /^[01]{12}$/;
  function et(t) {
    return Se.test(t);
  ...
  var xe = d("Pcset.pcset", "Pcset.get", p),
    gt = (t) => p(t).chroma,
    Ce = (t) => p(t).intervals,
    Ee = (t) => p(t).setNum,
    De = [
  ...
  function $e(t) {
    ...
    for (let r = 0; r < t.length; r++)
      (n = s(t[r])), n.empty && (n = l(t[r])), n.empty || (e[n.chroma] = 1);
    return e.join("");
  }
  var ke = [
      ["1P 3M 5P", "major", "M ^  maj"],
      ["1P 3M 5P 7M", "major seventh", "maj7 \u0394 ma7 Maj7 ^7"],
      ["1P 3M 5P 7M 9M", "major ninth", "maj9 \u03949 ^9"],
      ["1P 3M 5P 7M 9M 11P", "major eleventh", "maj11 Δ11 ^11"],
      ["1P 3M 5P 7M 9M 11P 13M", "major thirteenth", "maj13 Maj13 ^13"],
      ...
      [
        "1P 3m 5P 7M",
        "minor/major seventh",
        "m/ma7 m/maj7 mM7 mmaj7 mMaj7 m/M7 -\u03947 m\u0394 -^7",
      ],
      ["1P 3m 5P 6M", "minor sixth", "m6 -6"],
      ["1P 3m 5P 7m 9M", "minor ninth", "m9 -9"],
      ["1P 3m 5P 7M 9M", "minor/major ninth", "mM9 mMaj9 -^9 m9maj7 m9Maj7"],
      ["1P 3m 5P 7m 9M 11P", "minor eleventh", "m11 -11"],
      ["1P 3m 5P 7m 9M 11P 13M", "minor thirteenth", "m13 -13"],
      ...
      ["1P 3M 5P 7m 9M 11P 13M", "dominant thirteenth", "13"],
      ...
      ["1P 3M 5P 7m 9M 11P", "eleventh", "11"],
      [
        "1P 4P 5P 7m 9m",
  ...
  var Le = d("ChordType.chordType", "ChordType.get", rt);
  function Be() {
  ...
  var He = d("ChordType.entries", "ChordType.all", S);
  function Ke() {
    (z = []), (F = {});
  }
  function un(t, n, e) {
  ...
  function rr(t, n, e) {
    ...
    return (
      i.forEach((c, P) => {
        ...
        S()
          .filter((f) =>
            e.assumePerfectFifth && nr(f) ? f.chroma === h : f.chroma === c
          )
          .forEach((f) => {
            let x = f.aliases[0],
              C = a(P);
            P !== o
              ? m.push({ weight: 0.5 * n, name: `${C}${x}/${r}` })
              : m.push({ weight: 1 * n, name: `${C}${x}` });
          });
      }),
      m
    );
  ...
  var mr = d("ScaleDictionary.scaleType", "ScaleType.get", U);
  function T() {
    return it.slice();
  }
  var sr = d("ScaleDictionary.entries", "ScaleType.all", T);
  function cr() {
  ...
  var dr = d("Chord.chord", "Chord.get", O);
  function fr(t, n) {
    let [e, r] = Q(t);
    return e ? u(e, n) + r : t;
  }
  ...
  function Ct(t) {
    ...
    if (!o) return Ar;
    let a = xr(o.fraction, r.length),
      i = a[0] / a[1];
    return { ...o, name: t, dots: r, value: i, fraction: a };
  }
  var Sr = (t) => Ct(t).value,
    Tr = (t) => Ct(t).fraction,
    fn = { names: gr, shorthands: Ir, get: Ct, value: Sr, fraction: Tr };
  function jr(t, n, e) {
    st.push({
      empty: !1,
      dots: "",
  ...
  var Vr = [1, 2, 2, 3, 3, 4, 5, 5, 6, 6, 7, 7],
    Or = "P m M m M P d P m M m M".split(" ");
  function Rr(t) {
    let n = t < 0 ? -1 : 1,
      e = Math.abs(t),
      r = e % 12,
      o = Math.floor(e / 12);
    return n * (Vr[r] + 7 * o) + Or[r];
  }
  var $r = b,
    Pn = hn((t, n) => [t[0] + n[0], t[1] + n[1]]),
    kr = (t) => (n) => Pn(t, n),
    qr = hn((t, n) => [t[0] - n[0], t[1] - n[1]]);
  function Dt(t, n) {
    let e = pn(t);
    if (e.empty) return "";
    let [r, o, a] = e.coord;
  ...
  var Lr = Math.log(2),
    Br = Math.log(440);
  function ct(t) {
    let n = (12 * (Math.log(t) - Br)) / Lr + 69;
    return Math.round(n * 100) / 100;
  }
  var zr = "C C# D D# E F F# G G# A A# B".split(" "),
    Ur = "C Db D Eb E F Gb G Ab A Bb B".split(" ");
  function g(t, n = {}) {
    if (isNaN(t) || t === -1 / 0 || t === 1 / 0) return "";
    t = Math.round(t);
    let r = (n.sharps === !0 ? zr : Ur)[t % 12];
  ...
  function Hr(t) {
    return t
      .split("")
      .reduce((n, e, r) => (r < 12 && e === "1" && n.push(r), n), []);
  }
  function Kr(t) {
    return t
      .map(wt)
  ...
  function Ft(t) {
    return Array.isArray(t) ? Kr(t) : Hr(t);
  }
  function Xr(t) {
    let n = Ft(t);
    return (e) => {
  ...
  var Jr = ["C", "D", "E", "F", "G", "A", "B"],
    An = (t) => t.name,
    gn = (t) => t.map(s).filter((n) => !n.empty);
  function Wr(t) {
    return t === void 0 ? Jr.slice() : Array.isArray(t) ? gn(t).map(An) : [];
  }
  var v = s,
    Yr = (t) => v(t).name,
    Zr = (t) => v(t).pc,
  ...
  function $t(t, n) {
    ...
    if (e.empty) return "";
    let r = v(
      n || g(e.midi || e.chroma, { sharps: e.alt < 0, pitchClass: !0 })
    );
  ...
  var Mo = d("RomanNumeral.romanNumeral", "RomanNumeral.get", y);
  function ho(t = !0) {
    return (t ? ut : Ao).slice();
  }
  function vo(t) {
  ...
  function go(t) {
    ...
    return {
      ...
      name: n,
      roman: r,
      interval: l({ step: i, alt: m, dir: c }).name,
      acc: e,
      chordType: o,
      alt: m,
      step: i,
  ...
  var En = { names: ho, get: y, romanNumeral: Mo };
  var M = Object.freeze([]),
    ...
    Io = {
      ...
      minorRelative: "",
      scale: M,
      secondaryDominants: M,
      secondaryDominantsMinorRelative: M,
  ...
  function Do(t) {
    return typeof t == "number"
      ? W("C", t)
      : typeof t == "string" && /^b+|#+$/.test(t)
      ? W("C", _(t))
      : null;
  }
  var wn = { majorKey: Co, majorTonicFromKeySignature: Do, minorKey: Eo };
  var Gt = [
  ...
  var _o = d("Mode.mode", "Mode.get", R);
  function Vn() {
    return Lt.slice();
  }
  var wo = d("Mode.mode", "Mode.all", Vn);
  function Fo() {
  ...
  var kn = { fromRomanNumerals: qo, toRomanNumerals: Go };
  function qn(t) {
  ...
  var Gn = { numeric: qn, chromatic: Lo };
  var Bo = {
    empty: !0,
    name: "",
    type: "",
  ...
  var ta = {
    ...
    na = ["4/4", "3/4", "2/4", "2/2", "12/8", "9/8", "6/8", "3/8"];
  function ea() {
    return na.slice();
  }
  var ra = /^(\d*\d(?:\+\d)*)\/(\d+)$/,
  ...
  var Kn = { names: ea, parse: Bt, get: oa },
    aa = (t) => (Math.log(t) / Math.log(2)) % 1 === 0;
  function ia([t, n]) {
    let e = Array.isArray(t) ? t.reduce((m, c) => m + c, 0) : t,
      r = n;
    if (e === 0 || r === 0) return ta;
